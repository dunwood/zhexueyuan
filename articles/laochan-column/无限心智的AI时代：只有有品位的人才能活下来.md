...
![图片](/articles/images/无限心智的AI时代：只有有品位的人才能活下来/img_25.jpg)
...
作者：Ivan Zhao联合创始人兼 CEO

每一个时代都由其“奇迹材料”所塑造。钢铁锻造了镀金时代。半导体点亮了数字时代。如今，人工智能以“无限心智”的形态到来。如果历史教会了我们任何事情，那就是：掌握这种材料的人，将定义这个时代。

![图片](/articles/images/无限心智的AI时代：只有有品位的人才能活下来/img_26.jpg)

左图：少年时期的安德鲁·卡内基与他的弟弟。右图：镀金时代的匹兹堡钢铁工厂。

在 1850 年代，安德鲁·卡内基作为电报送报员，奔跑在泥泞的匹兹堡街道上。那时，每十个美国人中有六个是农民。不到两代人的时间，卡内基和他的同辈锻造出了现代世界。马匹让位于铁路，烛光让位于电力，铁让位于钢。

自那之后，工作从工厂转移到办公室。如今，我在旧金山经营一家软件公司，为数百万知识工作者构建工具。在这座以行业闻名的城市里，每个人都在谈论 AGI，但那二十亿办公桌前的工作者中的大多数，尚未真正感受到它的影响。知识工作很快将呈现出怎样的面貌？当组织架构图吸纳那些永不入眠的心智时，会发生什么？

早期电影常常看起来像舞台剧，单一摄像机对准舞台。

![图片](/articles/images/无限心智的AI时代：只有有品位的人才能活下来/img_27.jpg)

这种未来往往难以预测，因为它总是伪装成过去的样子。早期的电话通话简短如电报。早期的电影看起来像被拍摄下来的戏剧。（这正是马歇尔·麦克卢汉所说的“通过后视镜驶向未来”。）

当今最流行的 AI 形态，看起来像过去的 Google 搜索。引用马歇尔·麦克卢汉的话：“我们总是在通过后视镜驶向未来。”

![图片](/articles/images/无限心智的AI时代：只有有品位的人才能活下来/img_28.jpg)

今天，我们看到的，是模仿 Google 搜索框的 AI 聊天机器人。我们正深陷于那种在每一次技术转型中都会出现的令人不适的过渡阶段。

我并没有关于下一步会发生什么的全部答案。但我喜欢借助一些历史隐喻，来思考 AI 如何在不同尺度上运作——从个人到组织，再到整个经济体。

**个体：从自行车到汽车**

最初的端倪可以在知识工作的“高级祭司”身上找到：程序员。

我的联合创始人 Simon 是我们所谓的“10 倍程序员”，但如今他几乎不再亲自写代码。走过他的办公桌，你会看到他同时编排三到四个 AI 编码代理，而它们不仅打字更快，它们还会思考，这使他成为一名 30 到 40 倍效率的工程师。他在午餐前或睡前排好任务队列，让它们在他离开时持续工作。他已经成为“无限心智”的管理者。

20 世纪 70 年代《科学美国人》关于运动效率的一项研究，启发了史蒂夫·乔布斯提出“心智的自行车”这一著名隐喻。而自那以后，我们已经在“信息高速公路”上踩踏了几十年。

![图片](/articles/images/无限心智的AI时代：只有有品位的人才能活下来/img_29.jpg)

在 1980 年代，史蒂夫·乔布斯称个人电脑为“心智的自行车”。十年之后，我们铺设了名为互联网的“信息高速公路”。但今天，大多数知识工作仍然依赖人力驱动。这就像我们一直在高速公路上骑自行车。

有了 AI 代理，像 Simon 这样的人，已经从骑自行车升级为驾驶汽车。

其他类型的知识工作者何时才能开上“汽车”？必须解决两个问题。

与编码代理相比，为什么 AI 更难以帮助一般知识工作？因为知识工作更加碎片化，也更难以验证。

![图片](/articles/images/无限心智的AI时代：只有有品位的人才能活下来/img_30.jpg)

**第一，语境碎片化。**

对于编程而言，工具和语境往往集中在一个地方：IDE、代码仓库、终端。但一般的知识工作却分散在数十种工具之中。设想一个 AI 代理要起草一份产品说明书：它需要从 Slack 线程中提取信息，从战略文档中引用内容，从仪表盘中读取上季度指标，还要调用只存在于某个人头脑中的机构记忆。今天，人类充当着“胶水”的角色，通过复制粘贴与浏览器标签页之间的切换，将这一切拼接起来。在这些语境得到整合之前，代理将始终被困在狭窄的使用场景之中。

**第二个缺失的要素是可验证性。**

代码具有一种神奇的属性：你可以通过测试与报错来验证它。模型开发者正是利用这一点训练 AI 提升编程能力（例如强化学习）。但你如何验证一个项目是否管理得好？或者一份战略备忘录是否优秀？我们尚未找到提升模型在一般知识工作方面能力的方法。因此，人类仍然需要处于“回路之中”，进行监督、引导，并示范什么是“好的样子”。

1865 年的《红旗法案》要求车辆在街道行驶时必须由一名持旗人走在前方（1896 年废除）。这是一个不理想的“人类在回路中”的例子。

![图片](/articles/images/无限心智的AI时代：只有有品位的人才能活下来/img_31.jpg)

今年的编程代理告诉我们，“人类在回路中”并不总是理想的。这就像在工厂流水线上让某个人亲自检查每一颗螺栓，或者让一个人走在汽车前面清路（参见：1865 年的《红旗法案》）。我们希望人类从一个具有杠杆效应的位置监督这些回路，而不是置身其中。一旦语境被整合，工作变得可验证，数十亿劳动者将从踩踏到驾驶，再从驾驶到自动驾驶。

**组织：钢铁与蒸汽**

公司是一项相对晚近的发明。它们在规模扩张时会退化，并最终触及极限。

1855 年纽约与伊利铁路公司的组织架构图。现代公司与组织架构图随着铁路公司的发展而演化，铁路公司是首批需要在广阔距离上协调数千人的企业。

![图片](/articles/images/无限心智的AI时代：只有有品位的人才能活下来/img_32.jpg)

1855 年纽约与伊利铁路公司的组织架构图。现代公司与组织架构图随着铁路公司的发展而演化，铁路公司是首批需要在广阔距离上协调数千人的企业。

几百年前，大多数公司只是由十几人组成的作坊。如今，我们拥有员工数以十万计的跨国企业。沟通基础设施（由会议和信息连接起来的人类大脑）在指数级负载下开始崩溃。我们试图用层级、流程和文档来解决这个问题。但我们一直在用人类尺度的工具解决工业尺度的问题，就像用木头建造摩天大楼。

两个历史隐喻展示了，当拥有新的“奇迹材料”时，未来的组织可以呈现出怎样不同的样貌。

钢铁的奇迹：伍尔沃斯大厦在 1913 年于纽约落成时，是世界上最高的建筑。

![图片](/articles/images/无限心智的AI时代：只有有品位的人才能活下来/img_33.jpg)

第一个隐喻是钢铁。在钢铁出现之前，19 世纪的建筑高度通常受限于六到七层。铁虽然坚固，但脆且沉重；层数增加，结构便会因自身重量而坍塌。钢铁改变了一切。它既坚固又具有延展性。框架可以更轻，墙体可以更薄，于是建筑可以拔地而起，达到数十层。新的建筑类型成为可能。

AI 之于组织，正如钢铁之于建筑。它有潜力在工作流程之间维持语境，并在需要时呈现决策，而不带来噪音。人类沟通不再必须充当承重墙。每周两小时的对齐会议，变成五分钟的异步审阅。原本需要三级审批的高管决策，可能很快在几分钟内完成。公司可以扩张，真正地扩张，而无需承受我们早已视为不可避免的退化。

一座以水轮驱动运作的磨坊。水力强大，却不稳定，并且将磨坊限制在少数地点与季节之中。

![图片](/articles/images/无限心智的AI时代：只有有品位的人才能活下来/img_34.jpg)

第二个故事关于蒸汽机。在工业革命初期，早期的纺织厂建在河流与溪流旁，由水轮驱动。当蒸汽机问世时，工厂主最初只是用蒸汽机替换水轮，而其余一切保持不变。生产率提升幅度有限。

真正的突破发生在工厂主意识到他们可以彻底摆脱对水的依赖之时。他们在更靠近工人、港口与原材料的地方建造更大的工厂。他们围绕蒸汽机重新设计工厂布局。（后来，当电力投入使用，工厂主进一步去中心化，不再依赖中央动力轴，而是在工厂各处为不同机器安装小型电机。）生产率随之爆发式增长，第二次工业革命由此真正起飞。

这幅由 Thomas Allom 于 1835 年创作的版画描绘了英国兰开夏郡的一家纺织厂。它由蒸汽机驱动。

![图片](/articles/images/无限心智的AI时代：只有有品位的人才能活下来/img_35.jpg)

我们仍然处于“替换水轮”的阶段。AI 聊天机器人被螺栓式地附加到现有工具之上。我们尚未重新想象，当旧有约束消解，当公司可以依靠那些在你入睡时仍然运作的“无限心智”运行时，组织会呈现出怎样的形态。

在我的公司 Notion，我们一直在进行实验。在 1,000 名员工之外，如今已有超过 700 个代理承担重复性工作。它们记录会议笔记，回答问题以整合部落式知识。它们处理 IT 请求，记录客户反馈。它们帮助新员工了解员工福利。它们撰写每周状态报告，使人们不必再复制粘贴。而这只是婴儿般的第一步。真正的增益，只受限于我们的想象力与惯性。

**经济：从佛罗伦萨到巨型都市**

钢铁与蒸汽不仅改变了建筑和工厂，它们改变了城市。

佛罗伦萨与东京。

![图片](/articles/images/无限心智的AI时代：只有有品位的人才能活下来/img_36.jpg)

直到几百年前，城市仍然是“人类尺度”的。你可以在四十分钟内步行穿越佛罗伦萨。生活的节奏由一个人能走多远、一种声音能传多远所决定。

随后，钢结构使摩天大楼成为可能。蒸汽机驱动铁路，将城市中心与腹地连接起来。电梯、地铁、高速公路接踵而至。城市在规模与密度上爆炸式增长。东京。重庆。达拉斯。

这些城市不仅仅是更大的佛罗伦萨。它们是截然不同的生活方式。巨型都市令人迷失、匿名、难以导航。这种“不可读性”是规模的代价。但它们也提供更多机会，更多自由。更多人以更多组合方式从事更多事情——这是一个人类尺度的文艺复兴城市无法承载的。

我认为，知识经济即将经历同样的转型。

今天，知识工作占据了美国 GDP 的近一半。它的大部分仍然在“人类尺度”上运作：几十人的团队，由会议与电子邮件节奏驱动的工作流程，超过几百人便开始承压的组织。我们用石头与木头建造了一个个“佛罗伦萨”。

当 AI 代理在规模上全面上线，我们将建造“东京”。那些横跨数千个代理与人类的组织。那些跨越时区、持续运转、无需等待某人醒来的工作流程。那些以恰到好处的“人类在回路中”方式综合生成的决策。

那将是一种不同的感受。更快，更具杠杆效应，但在最初也更令人迷失。每周会议的节奏、季度规划周期、年度评估，可能不再有意义。新的节奏将浮现。我们会失去一部分“可读性”。我们会获得规模与速度。

**超越水轮**

每一种奇迹材料，都要求人们停止通过后视镜看世界，开始想象一个新的世界。卡内基看着钢铁，看见的是城市天际线。兰开夏的工厂主看着蒸汽机，看见的是摆脱河流束缚的厂房地面。

我们仍处在 AI 的“水轮阶段”，把聊天机器人螺栓式地安装到为人类设计的工作流程之上。我们需要停止只把 AI 视为副驾驶。我们需要想象，当人类组织被钢铁加固，当琐碎事务被那些永不入眠的心智所接管时，知识工作会呈现怎样的样貌。
...
![图片](/articles/images/无限心智的AI时代：只有有品位的人才能活下来/img_37.jpg)
...
![图片](/articles/images/无限心智的AI时代：只有有品位的人才能活下来/img_38.jpg)
...
![图片](/articles/images/无限心智的AI时代：只有有品位的人才能活下来/img_39.jpg)
...
![图片](/articles/images/无限心智的AI时代：只有有品位的人才能活下来/img_40.jpg)
...
![图片](/articles/images/无限心智的AI时代：只有有品位的人才能活下来/img_41.jpg)
...
![图片](/articles/images/无限心智的AI时代：只有有品位的人才能活下来/img_42.jpg)
...
![图片](/articles/images/无限心智的AI时代：只有有品位的人才能活下来/img_43.jpg)
...
![图片](/articles/images/无限心智的AI时代：只有有品位的人才能活下来/img_44.jpg)
...
![图片](/articles/images/无限心智的AI时代：只有有品位的人才能活下来/img_45.jpg)
...
![图片](/articles/images/无限心智的AI时代：只有有品位的人才能活下来/img_46.jpg)
...
![图片](/articles/images/无限心智的AI时代：只有有品位的人才能活下来/img_47.jpg)
...
![图片](/articles/images/无限心智的AI时代：只有有品位的人才能活下来/img_48.jpg)
